...
//        SYYH("syyh","syyh",12,16,18,24);
        ...
        FontType(String fontName, String boldName, int... sizes) {
            this.location = new ResourceLocation("promodule","font/" + fontName + ".ttf");
            this.boldLocation = new ResourceLocation("promodule","font/" + boldName + ".ttf");
            this.sizes = sizes;
        }
