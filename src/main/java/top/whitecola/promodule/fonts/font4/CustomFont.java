...
import top.whitecola.promodule.utils.wrapper.MutablePair;
...
public class CustomFont implements IFontRenderer{
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '§') {
                ...
                if (colorIndex < 16) {
                    ...
                    Render3DUtils.color(colorCode[colorIndex], alpha);
                } else {
                    switch (colorIndex) {
                        case 17:
                            if (hasBoldFont()) {
    ...
    private static class FontData {
        ...
        public MutablePair<Integer, Integer> getImageSize() {
            return imageSize;
        }
