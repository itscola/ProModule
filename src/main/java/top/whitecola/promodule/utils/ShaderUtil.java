...
public class ShaderUtil {
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("promodule/shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "promodule/shaders/vertex.vsh");
    }
    ...
    private int createShader(InputStream inputStream, int shaderType) {
        ...
        glShaderSource(shader, HiFile.readInputStream(inputStream));
