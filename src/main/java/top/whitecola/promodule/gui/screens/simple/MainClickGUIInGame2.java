...
public class MainClickGUIInGame2 extends GuiScreen implements IMainClickGUIIngame{
    ...
    protected Color backgroundColor = new Color(56, 56, 56);
    protected Color mainColor = new Color(35, 35, 35);
    protected Color titleColor = new Color(205, 205, 205);
    protected Color subColor = new Color(4, 115, 130);

    protected Color barColor = new Color(33, 33, 33);
    protected Color githubColor = new Color(24, 24, 24);
    protected Color textColor = new Color(212, 212, 212);

    protected Color selectedEntryColor = new Color(128, 35, 193, 255);
    protected Color selectedEntryTextColor = new Color(36, 36, 36);

    protected Color unSelectedSubEntryColor = new Color(54, 54, 54);
    protected Color unSelectedSubEntryTextColor = new Color(127, 127, 127);

    protected Color selectedSubEntryColor = new Color(128, 35, 193, 255);
    protected Color selectedSubEntryTextColor = new Color(36, 36, 36);
